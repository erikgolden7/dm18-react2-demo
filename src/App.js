  ...
  render() {
    ...
    return (
      <div>
        <h3> General List </h3>
        {peopleList}
        <PickedList name="John" confirmMethod={this.handleConfirm} />
        <PickedList name="Bob" confirmMethod={this.handleConfirm} />
        <PickedList name="Harry" confirmMethod={this.handleConfirm} />
        <PickedList name="Lina" confirmMethod={this.handleConfirm} />
        <PickedList name="Stacy" confirmMethod={this.handleConfirm} />
        <h3> Picked List </h3>
        {pickedList}
      </div>
    );
